...
public class SubscribeRequestHandler extends RequestHandler {
    ...
    public SubscribeRequestHandler(W3CWebSocket clientsocket, Request request, SignalInterface signalinterface) {
    ...
    public void HandleRequest() {
        Log.d(Constants.LOG_TAG, "W3CWebSocketServer, Received : SubscribeRequest");
        this._clientsocket.send("Received : SubscribeRequest");
