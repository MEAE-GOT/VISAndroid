...
public class GetVssRequestHandler extends RequestHandler {

    public GetVssRequestHandler(W3CWebSocket clientsocket, Request request, SignalInterface signalinterface) {
    ...
    public void HandleRequest() {
        Log.d(Constants.LOG_TAG, "W3CWebSocketServer, Received : GetVssRequest");
        this._clientsocket.send("Received : GetVssRequest");
