...
public class SetRequestHandler extends RequestHandler {
    ...
    public SetRequestHandler(W3CWebSocket clientsocket, Request request, SignalInterface signalinterface) {
    ...
    public void HandleRequest() {
        Log.d(Constants.LOG_TAG, "W3CWebSocketServer, Received : SetRequest");
        this._clientsocket.send("Received : SetRequest");
